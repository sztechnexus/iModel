...
| 平台          | 架构                | 下载链接                                                     |  大小  | 系统要求                  |
| :------------ | :------------------ | :----------------------------------------------------------- | :----: | :------------------------ |
| 🍎 **macOS**   | Apple Silicon (ARM) | [下载 iModel-2.0.85-macOS-arm64.pkg](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-2.0.85-macOS-arm64.pkg) | ~33 MB | macOS 13.x 或更高版本     |
| 🍎 **macOS**   | Intel (X64)         | [下载 iModel-2.0.85-macOS-x64.pkg](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-2.0.85-macOS-x64.pkg) | ~36 MB | macOS 13.x 或更高版本     |
| 🪟 **Windows** | X64                 | [下载 iModel-2.0.85-windows-x64-setup.exe](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-2.0.85-windows-x64-setup.exe) | ~19 MB | Windows 10/11             |
| 🪟 **Windows** | ARM                 | [下载 iModel-2.0.85-windows-arm64-setup.exe](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-2.0.85-windows-arm64-setup.exe) | ~18 MB | Windows 10/11             |
| 🐧 **Linux**   | X64                 | [下载 iModel-2.0.85-linux-x64.tar.gz](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-2.0.85-linux-x64.tar.gz) | ~37 MB | Ubuntu 20.04+ / CentOS 7+ |
| 🐧 **Linux**   | ARM64               | [下载 iModel-2.0.85-linux-arm64.tar.gz](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-2.0.85-linux-arm64.tar.gz) | ~36 MB | Ubuntu 24.04 或更高版本   |

### 一键安装 — Pro 版 (v2.0.85)

| 平台          | 架构                | 下载链接                                                     |  大小   | 系统要求                  |
| :------------ | :------------------ | :----------------------------------------------------------- | :-----: | :------------------------ |
| 🍎 **macOS**   | Apple Silicon (ARM) | [下载 iModel-Pro-2.0.85-macOS-arm64.pkg](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-Pro-2.0.85-macOS-arm64.pkg) | ~276 MB | macOS 13.x 或更高版本     |
| 🍎 **macOS**   | Intel (X64)         | [下载 iModel-Pro-2.0.85-macOS-x64.pkg](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-Pro-2.0.85-macOS-x64.pkg) | ~164 MB | macOS 13.x 或更高版本     |
| 🪟 **Windows** | X64                 | [下载 iModel-Pro-2.0.85-windows-x64-setup.exe](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-Pro-2.0.85-windows-x64-setup.exe) | ~200 MB | Windows 10/11             |
| 🐧 **Linux**   | X64                 | [下载 iModel-Pro-2.0.85-linux-x64.tar.gz](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-Pro-2.0.85-linux-x64.tar.gz) | ~373 MB | Ubuntu 20.04+ / CentOS 7+ |
| 🐧 **Linux**   | ARM64               | [下载 iModel-Pro-2.0.85-linux-arm64.tar.gz](https://github.com/sztechnexus/iModel/releases/download/v2.0/iModel-Pro-2.0.85-linux-arm64.tar.gz) | ~331 MB | Ubuntu 24.04 或更高版本   |
...
*版本 2.0.85 · 支持 macOS / Windows / Linux*
